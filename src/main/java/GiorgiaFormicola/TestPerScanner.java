    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            try {
                ...
                if (tipoUtente < 1 || tipoUtente > 3) throw new NumberFormatException();
                else break;
        ...
        if (tipoUtente == 1 || tipoUtente == 2) {
            while (true) {
                ...
                try {
                    ...
                    if (simulazione < 1 || simulazione > 3) throw new NumberFormatException();
                    else break;
                } catch (NumberFormatException e) {
            ...
            while (true) {
                ...
                try {
                    ...
                    if (simulazione != 4) throw new NumberFormatException();
                    else break;
                } catch (NumberFormatException e) {
                    System.err.println("\nERRORE: Simulazione selezionata non valida, riprovare! \n");
                }
        ...
        //TODO: DISTIBUTORE NON ATTIVO 39cebfa3-fe67-46ca-a441-64b5132afcb5
        //TODO: DISTIBUTORE ATTIVO 5e6d6394-2e6b-441e-a693-fceb7e967fa3
        ...
        //TODO: MEZZO FUORI SERVIZIO 4225d884-1c6a-4da1-86d5-c81ebe003317
        //TODO: MEZZO IN SERVIZIO 23050bd5-a65b-49d0-b265-f384459d93ca
        //TODO: BIGLIETTO GIA' VIDIMATO 17498549-843d-4f5f-a196-530328dac227
        //TODO: BIGLIETTO VALIDO 0be241e3-d7dd-4c5b-8db1-3f48a8d2819f
        ...
        //TODO: CODICE FISCALE NON VALIDO ciao
        //TODO: CODICE FISCALE GIA' REGISTRATO PLZCRL66R45G273W
        //TODO: CODICE FISCALE VALIDO AKFDRL66R45G273T
        if (tipoUtente == 1 && simulazione == 3) {
            while (true) {
                ...
                } catch (NumberFormatException | CodiceFiscaleNonValidoException e) {
        ...
        //TODO: DISTIBUTORE ATTIVO 5e6d6394-2e6b-441e-a693-fceb7e967fa3
        //TODO: TESSERA SENZA ABBONAMENTO 5
        //TODO: TESSERA CON ABBONAMENTO NON SCADUTO f06239cb-7507-42a1-85d3-cf19d74d385f TESSERA 4
        //TODO: UTENTE CON ABBONAMENTO SCADUTO 9b4787b3-4520-46e9-bd9e-6c0ab879e20a TESSERA 3
        ...
        //TODO: MEZZO FUORI SERVIZIO 4225d884-1c6a-4da1-86d5-c81ebe003317
        //TODO: MEZZO IN SERVIZIO 23050bd5-a65b-49d0-b265-f384459d93ca
        //TODO: UTENTE CON ABBONAMENTO NON SCADUTO f06239cb-7507-42a1-85d3-cf19d74d385f TESSERA 4
        //TODO: UTENTE CON ABBONAMENTO SCADUTO 9b4787b3-4520-46e9-bd9e-6c0ab879e20a TESSERA 3
        ...
        //TODO: CODICE FISCALE NON REGISTRATO ciao
        //TODO: CODICE FISCALE SENZA TESSERA CFGCRL66R45G272I
        //TODO: CODICE FISCALE CON TESSERA SCADUTA PLZCRL66R45G273W
        //TODO: CODICE FISCALE CON TESSERA VALIDA SENZA ABBONAMENTO ABCCRL66R45G272H
        //TODO: CODICE FISCALE CON TESSERA VALIDA CON ABBONAMENTO RSSMRA85M01H501Z
            ...
            while (true) {
                ...
                try {
                    ...
                    if (operazione == 2) {
                        ...
                        } catch (TesseraAncoraValidaException | NullPointerException e) {
                            if (e instanceof NullPointerException)
                                System.err.println("Utente non associato ad alcuna tessera");
                    ...
                    if (operazione == 4) {
                        ...
                        } catch (TesseraScadutaException | AbbonamentoTesseraNonTrovatoException |
        ...
        //TODO: CODICE FISCALE UTENTE SEMPLICE RSSMRA85M01H501Z
        //TODO: CODICE FISCALE AMMINISTRATORE BNCGPP92C15F839K
        if (tipoUtente == 3) {
            ...
            while (true) {
                ...
                try {
                    ...
                    if (areaPortale == 1) {
                        ...
                        while (true) {
                            ...
                            try {
                                ...
                                //OPERAZIONE 2
                                //TODO: DISTRIBUTORE AUTOMATICO NON ATTIVO 39cebfa3-fe67-46ca-a441-64b5132afcb5
                                //TODO: DISTRIBUTORE AUTOMATICO ATTIVO 5e6d6394-2e6b-441e-a693-fceb7e967fa3
                                if (operazione == 2) {
                                ...
                                //OPERAZIONE 4
                                //TODO: DISTRIBUTORE AUTOMATICO ATTIVO 39cebfa3-fe67-46ca-a441-64b5132afcb5
                                //TODO: DISTRIBUTORE AUTOMATICO NON ATTIVO 5e6d6394-2e6b-441e-a693-fceb7e967fa3
                                if (operazione == 4) {
                                    System.out.println("\nInserire l'id del distributore automatico interessato");
                                    String idDistributore = scanner.nextLine();
                                    try {
                    ...
                    if (areaPortale == 2) {
                        ...
                        while (true) {
                            System.out.println("\nSCEGLIERE IL TIPO DI OPERAZIONE DA SVOLGERE DIGITANDO IL RISPETTIVO NUMERO");
                            System.out.println("1.Ottieni il totale di emissioni avvenute in uno specifico arco di tempo");
                            System.out.println("2.Ottieni il totale di emissioni emesse da uno specifico punto di emissione");
                            System.out.println("3.Ottieni il totale di biglietti vidimati su uno specifico mezzo");
                            System.out.println("0.TORNA AL MENU GESTIONI");
                            try {
                                operazione = Integer.parseInt(scanner.nextLine());
                                if (operazione == 0) break;
                                ...
                                //OPERAZIONE 1
                                //TODO: test oggi
                                //TODO: test prima di oggi
                                //TODO: test dopo ieri
                                //TODO: tra ieri e oggi
                                //TODO: fino ad oggi
                                if (operazione == 1) {
                                    while (true) {
                                        System.out.println("\nChe tipo di emissione vuoi verificare?");
                                        /*System.out.println("1.Tutte");*/
                                        System.out.println("1.Solo biglietti");
                                        System.out.println("2.Solo abbonamenti");
                                        System.out.println("0.CAMBIA IL TIPO DI OPERAZIONE DA SVOLGERE");
                                        int tipoEmissione;
                                        try {
                                            tipoEmissione = Integer.parseInt(scanner.nextLine());
                                            if (tipoEmissione == 0) break;
                                            if (tipoEmissione < 1 || tipoEmissione > 2)
                                                System.err.println("\nERRORE: Tipo selezionato non valido, riprovare!\n");
                                            else {
                                ...
                                //OPERAZIONE 2
                                //TODO: PUNTO EMISSIONE 15c4f726-4627-4b3c-ba5c-8a72fcbce881
                                //TODO: test con tutto, solo biglietti, solo abbonamenti
                                if (operazione == 2) {
                                    while (true) {
                                        try {
                                            System.out.println("\nChe tipo di emissione vuoi verificare?");
                                            ...
                                            if (tipoEmissione < 1 || tipoEmissione > 2)
                                                ...
                                                System.out.println("\nInserisci l'id del punto di emissione da verificare");
                                               ...
                                               /* if (tipoEmissione == 1) {
                                                ...
                                                if (tipoEmissione == 1) {
                                                    System.out.println("TOTALE DEI BIGLIETTI EMESSI DAL PUNTO CON ID " + idPunto + " : " + emissioniDAO.getTotaleBigliettiDaPuntoDiEmissione(idPunto));
                                                } else {
                                                    System.out.println("TOTALE DEGLI ABBONAMENTI EMESSI DAL PUNTO CON ID " + idPunto + " : " + emissioniDAO.getTotaleAbbonamentiDaPuntoDiEmissione(idPunto));
                                                }
                                            }
                                ...
                                //OPERAZIONE 3
                                //TODO: MEZZO CON BIGLIETTI VIDIMATI 23050bd5-a65b-49d0-b265-f384459d93ca
                                //TODO: MEZZO CON BIGLIETTI VIDIMATI 3c1eb68a-2298-4bc7-a03c-9278a7afb7d2
                                //TODO: test oggi
                                //TODO: test prima di oggi
                                //TODO: test dopo ieri
                                //TODO: tra ieri e oggi
                    ...
                    if (areaPortale == 3) {
                        ...
                        while (true) {
                            ...
                            try {
                                ...
                                //OPERAZIONE 2
                                //TODO: MEZZO IN SERVIZIO 23050bd5-a65b-49d0-b265-f384459d93ca
                                //TODO: MEZZO IN MANUTENZIONE 4225d884-1c6a-4da1-86d5-c81ebe003317
                                if (operazione == 2) {
                                ...
                                //OPERAZIONE 4
                                //TODO: MEZZO IN MANUTEZIONE 23050bd5-a65b-49d0-b265-f384459d93ca
                                //TODO: MEZZO IN SERVIZIO 4225d884-1c6a-4da1-86d5-c81ebe003317
                                if (operazione == 4) {
                                    System.out.println("\nInserire l'id del mezzo interessato");
                                    try {
                                        String idMezzo = scanner.nextLine();
                                ...
                                //OPERAZIONE 7
                                //TODO: MEZZO bf87348e-d420-45a2-ab96-8bfc9bff03ab
                                if (operazione == 7) {
                                    System.out.println("\nInserire l'id del mezzo interessato");
                                    try {
                                        String idMezzo = scanner.nextLine();
                    ...
                    if (areaPortale == 4) {
                        ...
                        while (true) {
                            ...
                            try {
                                ...
                                //OPERAZIONE 2
                                //TODO: TRATTA NON ASSEGNATA 35739230-e223-49a8-913a-3e7577ccf9a2
                                //TODO: MEZZO NON ASSEGNATO A NESSUNA TRATTA OGGI 3c1eb68a-2298-4bc7-a03c-9278a7afb7d2
                                if (operazione == 2) {
                                ...
                                //OPERAZIONE 3
                                //TODO: PRENDI ID DELLA NUOVA ASSEGNAZIONE CREATA
                                if (operazione == 3) {
                                ...
                                //OPERAZIONE 4
                                //TODO: TRATTA ASSEGNATA 121c4285-734d-4d10-b1a1-522c6298db1b
                                //TODO: MEZZO 23050bd5-a65b-49d0-b265-f384459d93ca
                                //TODO: MEZZO 3c1eb68a-2298-4bc7-a03c-9278a7afb7d2
                                if (operazione == 4) {
